...
if ($cart->getItems() != null) {
    foreach ($cart->getItems() as $cart_item) {
        ...
        echo '<td>
                <div class="row up_qty">
                        <div class="col-6">
                             <input id="qty" name="qty" type="text" class="input-sm form-control-sm form-control qty-up" size="1" value="' . $cart_item->getQty() . '" data-code="' . $pro->getId(). '"/>
                        </div>
                        <div class="col-6">
